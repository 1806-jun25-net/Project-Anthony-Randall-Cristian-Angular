...
export class InventoryDisplayByLocationComponent implements OnInit {
  ...
  resupplyInventory(){
    let city = this.route.snapshot.paramMap.get("city");
    this.api.resupplyInventoryAtThisLocation(city, (res)=>{console.log("successfully resupplied location"); this.ngOnInit()} , (res)=>console.log("inventory has not been resupplied"));
  }
}
